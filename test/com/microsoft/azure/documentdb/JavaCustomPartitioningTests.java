...
public class JavaCustomPartitioningTests extends GatewayTestBase {
    ...
    public JavaCustomPartitioningTests() {
        super();
    }
    ...
    public void testPartitioning() throws DocumentClientException {
        ...
        DocumentCollection collection0 = client.createCollection(TestUtils.getDatabaseLink(this.databaseForTest, true),
                collectionDefinition,
                null).getResource();

        collectionDefinition.setId("coll_1");
        DocumentCollection collection1 = client.createCollection(TestUtils.getDatabaseLink(this.databaseForTest, true),
                collectionDefinition,
                null).getResource();

        collectionDefinition.setId("coll_2");
        DocumentCollection collection2 = client.createCollection(TestUtils.getDatabaseLink(this.databaseForTest, true),
                collectionDefinition,
                null).getResource();

        // Iterator of ID based collection links
        ArrayList<String> collectionLinks = new ArrayList<String>();
        collectionLinks.add(TestUtils.getDocumentCollectionLink(this.databaseForTest, collection0, true));
        collectionLinks.add(TestUtils.getDocumentCollectionLink(this.databaseForTest, collection1, true));
        collectionLinks.add(TestUtils.getDocumentCollectionLink(this.databaseForTest, collection2, true));
        ...
        client.registerPartitionResolver(TestUtils.getDatabaseLink(this.databaseForTest, true), partitionResolver);
        ...
        client.createDocument(TestUtils.getDatabaseLink(this.databaseForTest, true),
                documentDefinition,
                null,
                false).getResource();

        // Read the documents in collection0 and verify that the count is 1 now
        List<Document> list = client.readDocuments(TestUtils.getDocumentCollectionLink(this.databaseForTest, collection0, true), null).getQueryIterable().toList();
        ...
        list = client.readDocuments(TestUtils.getDocumentCollectionLink(this.databaseForTest, collection1, true), null).getQueryIterable().toList();
        Assert.assertEquals(1, list.size());
        ...
        list = client.readDocuments(TestUtils.getDocumentCollectionLink(this.databaseForTest, collection2, true), null).getQueryIterable().toList();
        Assert.assertEquals(1, list.size());
        ...
        client.upsertDocument(TestUtils.getDatabaseLink(this.databaseForTest, true),
                documentDefinition,
                null,
                false).getResource();

        // Read the documents in collection0 and verify that the count is still 1
        list = client.readDocuments(TestUtils.getDocumentCollectionLink(this.databaseForTest, collection0, true), null).getQueryIterable().toList();
        Assert.assertEquals(1, list.size());
        ...
        list = client.queryDocuments(TestUtils.getDatabaseLink(this.databaseForTest, true),
    ...
    public void testPartitionPaging() throws DocumentClientException {
        ...
        String collectionId0 = TestUtils.getUID();
        collectionDefinition.setId(collectionId0);
        DocumentCollection collection0 = client.createCollection(TestUtils.getDatabaseLink(this.databaseForTest, true),
                collectionDefinition,
                null).getResource();

        String collectionId1 = TestUtils.getUID();
        ...
        List<Document> list = client.queryDocuments(TestUtils.getDatabaseLink(this.databaseForTest, true),
        ...
        QueryIterable<Document> query = client.queryDocuments(TestUtils.getDatabaseLink(this.databaseForTest, true),
                "SELECT * FROM root r WHERE r.id < '7'",
        ...
        query = client.queryDocuments(TestUtils.getDatabaseLink(this.databaseForTest, true),
                "SELECT * FROM root r WHERE r.id < '7'",
                feedOptions).getQueryIterable();
    ...
    public void testHashPartitionResolver() {
        ...
        collectionDefinition.setId("coll_0");
        collectionLinks.add(TestUtils.getDocumentCollectionLink(this.databaseForTest, collectionDefinition, true));
    ...
    public void testConsistentRing() {
        ...
        for (int i = 0; i < TotalCollectionsCount; i++) {
            coll.setId("coll" + i);
            collLink = TestUtils.getDocumentCollectionLink(databaseDefinition, coll, true);
