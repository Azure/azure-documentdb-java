...
final class SessionReadRetryPolicy implements RetryPolicy {
     ...
     * 
     * @param globalEndpointManager
     *            the GlobalEndpointManager instance.
     * @param request
     *            the current request to be retried.
     * 
     */
    public SessionReadRetryPolicy(GlobalEndpointManager globalEndpointManager, DocumentServiceRequest request) {
    ...
    public boolean shouldRetry(DocumentClientException exception) {
        ...
        if (this.currentRequest.getOperationType() == OperationType.Read && this.currentRequest.getEndpointOverride() == null && 
