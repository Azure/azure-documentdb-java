...
final class PartitionKeyMismatchRetryPolicy implements RetryPolicy {
     ...
     */
    public PartitionKeyMismatchRetryPolicy(String resourcePath, PartitionKeyDefinitionMap partitionKeyDefinitionMap) {
    ...
    public boolean shouldRetry(DocumentClientException exception) {
        ...
        this.partitionKeyDefinitionMap.RefreshEntry(collectionLink);
        this.currentAttempt++;
