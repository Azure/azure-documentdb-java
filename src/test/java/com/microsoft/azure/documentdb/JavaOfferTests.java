...
public class JavaOfferTests extends GatewayTestBase {
    ...
    public void testOfferReadAndQuery() throws DocumentClientException {
        ...
        List<Offer> queryResultList = client.queryOffers("SELECT * FROM root", null)
                .getQueryIterable().toList();
        Assert.assertEquals(1, queryResultList.size());

        // Query for the offer.
        queryResultList = client
    ...
    public void testCreateCollectionWithOfferThroughput() throws DocumentClientException {
        ...
        DocumentCollection createdCollection = client
                .createCollection(TestUtils.getDatabaseLink(this.databaseForTest, true), collectionDefinition, options)
                .getResource();
    ...
    public void testChangeOfferVersion() throws DocumentClientException {
        ...
        Offer v1NewOffer = new Offer(v1Offer);
        v1NewOffer.setOfferType("S3");
        Offer replacedOffer = client.replaceOffer(v1NewOffer).getResource();
        ...
        OfferV2 v2Offer = new OfferV2(v1NewOffer);
        v2Offer.setOfferThroughput(throughput);
        replacedOffer = client.replaceOffer(v2Offer).getResource();
